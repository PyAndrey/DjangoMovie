                    ...
                    {% for dir in dirs %}
                        ...
                        {% for file in files %}
                            {% if dir in file.src %}
                                <li>
                                    <a class="thumb"
                                       href="{% if file.is_image %}{{ file.src }}{% else %}{{ file.thumb }}{% endif %}">
                                    ...
                                    <div class="caption">
                                        <div class="submit-row">
                                            <input href="{{ file.src }}" class="default embed" type="submit"
                                                   name="_embed" value="{% trans "Embed Image" %}"/>
                                        </div>
                                    </div>
                                </li>
                            {% endif %}
                ...
                {% else %}
                    {% for file in files %}
                        <li>
                            ...
                            <div class="caption">
                                <div class="submit-row">
                                    <input href="{{ file.src }}" class="default embed" type="submit" name="_embed"
                                           value="{% trans "Embed Image" %}"/>
                                </div>
                            </div>
                        </li>
                    {% endfor %} <!-- for file in files -->
